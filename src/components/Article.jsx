  ...
  return (
    <div className="flex justify-center bg-bgDark2 relative pt-2">
      <div className="px-2 sm:px-4">
        <article className=" pt-8 pr-8 pl-8 pb-4 text-center rounded-3xl w-full lg:w-[1200px] 2xl:w-[1400px] mb-24 mt-16 sm:mt-24">
          <header className="mb-12">
            ...
            {(subtitle != undefined) ? <p className="text-lg text-secondaryText mb-4">{subtitle}</p> : ''}
          </header>
          {(image != undefined) ?
            <img
            src={image}
          ...
          />
          {(footer != undefined) ? <div className="w-4/5 lg:w-2/3 text-right mx-auto mt-8 text-primaryText text-xl">
            {footer}
          </div> : ''}
        </article>
      </div>
